 ...
 * @date on 2019-11-29
 */
public class ScrollView_ScrollView_OutActivity extends AppCompatActivity implements View.OnClickListener {


    public static void start(Context context) {
        context.startActivity(new Intent(context, ScrollView_ScrollView_OutActivity.class));
    }
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scrollview_scrollview_out);
