...
public class DFragment extends Fragment {
    ...
    private void initView(View view) {
        ...
        mViewPager = view.findViewById(R.id.vp_in_vp);
        ...
        fragments.add(EFragment.newInstance("#A52A2A"));
        fragments.add(EFragment.newInstance("#607B8B"));
        fragments.add(EFragment.newInstance("#0000FF"));
